...
<div class="bg-light-grey column is-1 is-flex is-flex-direction-column is-align-items-center is-justify-content-space-around">
    <p class="title is-5 mb-2 has-text-white">
        {
            DateTime.fromFormat(weather.dt, "ff").startOf("hour").toFormat("HH:mm")
        }
    </p>
    <WeatherIcon weather={weather.type_weather} />
